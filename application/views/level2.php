        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                  <div class="card container-fluid level-area">
                    <div class="card-body">
                      <form name="frmLevel2" method="POST" action="<?php echo site_url('level2/submit');?>" id="frm_level2">
                        <p class="h2 text-center py-4"><?php echo $level; ?></p>
                        <label for="defaultFormCardNameEx" class="grey-text">Hint: Send what you have securely</label>
